...
export function Main() {
  return (
    <div className="max-w-3xl mx-auto py-32 px-4">
      <div className="flex flex-col gap-2 pb-12 uppercase">
        <TitlePrincipal title="Desafios Vencidos"/>
        <div className="h-1 sm:w-96 bg-roxo-300"></div>
      </div>

      <div className="sm:text-2xl font-4 text-roxo-400 space-y-12">
        <div className="flex gap-8 items-center">
          <Image src={Number1} alt="Numero 1" className="w-12 sm:w-24 h-fit" />
          <p>
        ...
        <div className="flex gap-8 items-center">
          <Image src={Number2} alt="Numero 2" className="w-12 sm:w-24 h-fit" />
          <p>
        ...
        <div className="flex gap-8 items-center">
          <Image src={Number3} alt="Numero 3" className="w-12 sm:w-24 h-fit" />
          <p>
        ...
        <div className="flex gap-8 items-center">
          <Image src={Number4} alt="Numero 4" className="w-12 sm:w-24 h-fit" />
          <p>
        ...
        <div className="flex gap-8 items-center">
          <Image src={Number5} alt="Numero 5" className="w-12 sm:w-24 h-fit" />
          <p>
        ...
        <div className="flex gap-8 items-center">
          <Image src={Number6} alt="Numero 6" className="w-12 sm:w-24 h-fit" />
          <p>
        ...
        <div className="flex gap-8 items-center">
          <Image src={Number7} alt="Numero 7" className="w-12 sm:w-24 h-fit" />
          <p>
        ...
        <div className="flex gap-8 items-center">
          <Image src={Number8} alt="Numero 8" className="w-12 sm:w-24 h-fit" />
          <p>
        ...
        <div className="flex gap-8 items-center">
          <Image src={Number9} alt="Numero 9" className="w-12 sm:w-24 h-fit" />
          <p>
